...
while(notFoundYet) {
	...
	for(int i = 1; i <= sizeList; i++) {
		if(numbers[i-1].getText().equals(number)) {
			xpath = '//*[@id="root"]/div/div/div[2]/div[3]/div[3]/table/tbody/tr[' + i + ']/td[8]/svg[2]'
...
WebUI.takeFullPageScreenshotAsCheckpoint((((GlobalVariable.Screenshot + GlobalVariable.todayDate) + '/') + GlobalVariable.nowTime + '/') + 'buka popup hapus bab.png', FailureHandling.STOP_ON_FAILURE)
WebUI.delay(2)