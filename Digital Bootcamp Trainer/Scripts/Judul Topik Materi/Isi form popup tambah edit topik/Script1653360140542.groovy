...
String tingkatan = ExcelKeywords.getCellValueByAddress(sheet, 'F' + GlobalVariable.row)
String visibilitas = ExcelKeywords.getCellValueByAddress(sheet, 'G' + GlobalVariable.row)

WebUI.setText(findTestObject('Daftar Topik/Tambah topik/input_judul_topik_materi'), topik)
WebUI.delay(15)
//WebUI.uploadFile(findTestObject('Daftar Topik/Tambah topik/button_Upload'), GlobalVariable.dirProject + "\\DataSet\\" + thumbnail)
//WebUI.uploadFile(findTestObject('Daftar Topik/Tambah topik/button_Upload'), button)
...
WebUI.setText(findTestObject('Daftar Topik/Tambah topik/input_Visibilitas'), visibilitas)
WebUI.sendKeys(findTestObject('Daftar Topik/Tambah topik/input_Visibilitas'), Keys.chord(Keys.ENTER))

WebUI.takeFullPageScreenshotAsCheckpoint((((GlobalVariable.Screenshot + GlobalVariable.todayDate) + '/') + GlobalVariable.nowTime + '/') + 'pop up form tambah/edit topik.png', FailureHandling.STOP_ON_FAILURE)
WebUI.delay(2)